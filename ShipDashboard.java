...
public class ShipDashboard extends JFrame implements ActionListener {
	...
	public ShipDashboard() {
		...
		String[] from = { "Departure", "Mumbai", "Venice", "Miami", "Sydney", "Tokyo", "Cape Town" };
		...
		String[] from2 = { "Arrival", "Mumbai", "Venice", "Miami", "Sydney", "Tokyo", "Cape Town" };
		...
		String[] Type = { "Luxury AC Cabin", "Deluxe Non-AC Cabin", "Premium AC Seat", "Economy Non-AC Seat", "Deck Class" };
			...
			if (jComboBox.getSelectedIndex() == 0 && jComboBox2.getSelectedIndex() == 0) {
				...
				try {
					...
					if (jComboBox.getSelectedIndex() == 1 && jComboBox2.getSelectedIndex() == 2) {
						cost = 45000; // Mumbai to Venice
					} else if (jComboBox.getSelectedIndex() == 1 && jComboBox2.getSelectedIndex() == 3) {
						cost = 55000; // Mumbai to Miami
					} else if (jComboBox.getSelectedIndex() == 1 && jComboBox2.getSelectedIndex() == 4) {
						cost = 40000; // Mumbai to Sydney
					} else if (jComboBox.getSelectedIndex() == 1 && jComboBox2.getSelectedIndex() == 5) {
						cost = 35000; // Mumbai to Tokyo
					} else if (jComboBox.getSelectedIndex() == 1 && jComboBox2.getSelectedIndex() == 6) {
						cost = 42000; // Mumbai to Cape Town
					} else if (jComboBox.getSelectedIndex() == 2 && jComboBox2.getSelectedIndex() == 1) {
						cost = 45000; // Venice to Mumbai
					} else if (jComboBox.getSelectedIndex() == 2 && jComboBox2.getSelectedIndex() == 3) {
						cost = 38000; // Venice to Miami
					} else if (jComboBox.getSelectedIndex() == 2 && jComboBox2.getSelectedIndex() == 4) {
						cost = 52000; // Venice to Sydney
					} else if (jComboBox.getSelectedIndex() == 2 && jComboBox2.getSelectedIndex() == 5) {
						cost = 48000; // Venice to Tokyo
					} else if (jComboBox.getSelectedIndex() == 2 && jComboBox2.getSelectedIndex() == 6) {
						cost = 35000; // Venice to Cape Town
					} else if (jComboBox.getSelectedIndex() == 3 && jComboBox2.getSelectedIndex() == 1) {
						cost = 55000; // Miami to Mumbai
					} else if (jComboBox.getSelectedIndex() == 3 && jComboBox2.getSelectedIndex() == 2) {
						cost = 38000; // Miami to Venice
					} else if (jComboBox.getSelectedIndex() == 3 && jComboBox2.getSelectedIndex() == 4) {
						cost = 45000; // Miami to Sydney
					} else if (jComboBox.getSelectedIndex() == 3 && jComboBox2.getSelectedIndex() == 5) {
						cost = 50000; // Miami to Tokyo
					} else if (jComboBox.getSelectedIndex() == 3 && jComboBox2.getSelectedIndex() == 6) {
						cost = 42000; // Miami to Cape Town
					} else if (jComboBox.getSelectedIndex() == 4 && jComboBox2.getSelectedIndex() == 1) {
						cost = 40000; // Sydney to Mumbai
					} else if (jComboBox.getSelectedIndex() == 4 && jComboBox2.getSelectedIndex() == 2) {
						cost = 52000; // Sydney to Venice
					} else if (jComboBox.getSelectedIndex() == 4 && jComboBox2.getSelectedIndex() == 3) {
						cost = 45000; // Sydney to Miami
					} else if (jComboBox.getSelectedIndex() == 4 && jComboBox2.getSelectedIndex() == 5) {
						cost = 32000; // Sydney to Tokyo
					} else if (jComboBox.getSelectedIndex() == 4 && jComboBox2.getSelectedIndex() == 6) {
						cost = 38000; // Sydney to Cape Town
					} else if (jComboBox.getSelectedIndex() == 5 && jComboBox2.getSelectedIndex() == 1) {
						cost = 35000; // Tokyo to Mumbai
					} else if (jComboBox.getSelectedIndex() == 5 && jComboBox2.getSelectedIndex() == 2) {
						cost = 48000; // Tokyo to Venice
					} else if (jComboBox.getSelectedIndex() == 5 && jComboBox2.getSelectedIndex() == 3) {
						cost = 50000; // Tokyo to Miami
					} else if (jComboBox.getSelectedIndex() == 5 && jComboBox2.getSelectedIndex() == 4) {
						cost = 32000; // Tokyo to Sydney
					} else if (jComboBox.getSelectedIndex() == 5 && jComboBox2.getSelectedIndex() == 6) {
						cost = 45000; // Tokyo to Cape Town
					} else if (jComboBox.getSelectedIndex() == 6 && jComboBox2.getSelectedIndex() == 1) {
						cost = 42000; // Cape Town to Mumbai
					} else if (jComboBox.getSelectedIndex() == 6 && jComboBox2.getSelectedIndex() == 2) {
						cost = 35000; // Cape Town to Venice
					} else if (jComboBox.getSelectedIndex() == 6 && jComboBox2.getSelectedIndex() == 3) {
						cost = 42000; // Cape Town to Miami
					} else if (jComboBox.getSelectedIndex() == 6 && jComboBox2.getSelectedIndex() == 4) {
						cost = 38000; // Cape Town to Sydney
					} else if (jComboBox.getSelectedIndex() == 6 && jComboBox2.getSelectedIndex() == 5) {
						cost = 45000; // Cape Town to Tokyo
					}
