...
public class BusDashboard extends JFrame implements ActionListener {
	...
	public BusDashboard() {
		...
		String[] from = { "Departure", "Delhi", "Mumbai", "Bangalore", "Jaipur" };
		...
		String[] from2 = { "Arrival", "Delhi", "Mumbai", "Bangalore", "Jaipur" };
		...
		String[] Type = { "Volvo AC", "Sleeper Non-AC" };
		...
		String[] coach = { "Rajdhani Express", "Volvo Bus", "Express Bus", "Ashok Leyland", "Tata Motors", "SRS Travels" };
